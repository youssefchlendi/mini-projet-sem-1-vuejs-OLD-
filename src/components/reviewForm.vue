            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="close btn-danger" @click="hide" data-dismiss="modal" aria-label="Close">
        ...
        <form class="" id="reviewformulaire" @submit.prevent="onSubmit">
            ...
            <!-- <input type="submit" class="button" value="envoyer"> -->
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" @click="hide" data-dismiss="modal">Close</button>

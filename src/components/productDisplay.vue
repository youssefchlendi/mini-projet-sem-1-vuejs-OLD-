                ...
                <div class="row ">
                    ...
                    <div class="col-md-6 p-5 border-left">
                        ...
                        <button :disabled="canRem" @click="remFromCart" class="btn  btn-outline-danger"> <span
                            ...
                            <button class="btn  mx-3 mt-2 btn-outline-primary " type="button" data-toggle="collapse" @click="showc" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample"><i class="material-icons">
preview  </i></button>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="close btn-danger" @click="showm" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="modal-body">
                        <div class=" order-md-2 mb-4">
                            <ul class="list-group mb-3">
                                <div v-for="varient in this.varients" :key="varient.id">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" @click="showm" data-dismiss="modal">Close</button>
...
export default {
  ...
  data: function (){
        return{
            img:"../assets/images/socks_blue.png",
            brand : "VueJs",
            product : "Chausette",
    ...
    methods : {
        ...
        showc(){
            window.$('#collapseExample').hasClass("show")?window.$('#collapseExample').collapse("hide"):window.$('#collapseExample').collapse("show");
